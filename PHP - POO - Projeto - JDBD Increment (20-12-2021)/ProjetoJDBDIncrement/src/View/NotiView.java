...
public class NotiView extends javax.swing.JFrame {
    ...
    public int getTxtNum5(){
        int numBox = jComboBox1.getSelectedIndex();
        return numBox;
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Midias", "Usuários", "Artigos"}));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotiView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

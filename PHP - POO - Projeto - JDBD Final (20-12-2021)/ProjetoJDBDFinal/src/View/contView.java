...
public class contView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(contView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
